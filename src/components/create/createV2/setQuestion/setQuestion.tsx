...
export default function SetQuestion({
  ...
  editQuestion,
  questionErrorArr,
  typeOfQuestionSelected,
  setTypeOfQuestionSelected,
}: {
  question: QuestionWithError;
  i: number;
  removeSelectedImage: (id: string, refresh?: boolean) => void;
          ...
          <div className={styles.typeOfQuestionInput}>
            ...
            <div className={`${styles.inputBox}`}>
              ...
              <select
                ...
                name="question"
                id="question"
                onChange={(e) => editQuestion("type", e.target.value, i)}
              >
                <option value="multiple">Selección múltiple</option>
                <option value="open">Pregunta abierta</option>
              </select>
            </div>
            <div onClick={() => deleteQuestion(i)} className={styles.deleteBtn}>
              <svg
                width="40px"
                height="40px"
                viewBox="0 0 24 24"
